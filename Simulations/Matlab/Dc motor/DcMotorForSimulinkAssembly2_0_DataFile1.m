...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(2).translation = [-4.1833853842945139 2.5476490248169097 -15.27746486552928];  % mm
smiData.RigidTransform(2).angle = 3.1415926535897927;  % rad
smiData.RigidTransform(2).axis = [1 3.7011070263610309e-32 1.523370472579168e-16];
...
smiData.RevoluteJoint(1).Rz.Pos = 92.529122882005993;  % deg
